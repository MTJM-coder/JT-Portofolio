...
const Education = () => {
    return (
        <div id='education' className='p-5 md:p-10'>
            <h2 className=' font-bold text-3xl text-blue-400 mb-2'>Ed<span className='border-b-2 pb-3'>ucati</span>on</h2>
            <div className='flex flex-col md:flex-row py-10'>
                <div className='my-5 w-full hover:scale-110 hover:border-blue-400 hover:border-2 shadow-white md:w-[30%] md:mx-5 h-[30vh] bg-slate-800 rounded justify-center items-center lg:text-2xl font-bold p-5 '>
                ...
                <div className='my-5 w-full hover:scale-110 hover:border-blue-400 hover:border-2 shadow-white md:w-[30%] md:mx-5 h-[30vh] bg-slate-800 rounded justify-center items-center lg:text-2xl font-bold p-5 '>
                 ...
                 <div className='my-5 w-full hover:scale-110 hover:border-blue-400 hover:border-2 shadow-white md:w-[32%] md:mx-5 sm:mr-10 h-[30vh] bg-slate-800 rounded justify-center items-center lg:text-2xl font-bold p-5 '>
                    <div className='text-center mb-5'>

    ...
    return (
        <div id='projects' className='p-5 md:p-10'>
            ...
            <div className='flex flex-col lg:flex-row flex-wrap gap-6 mt-10'>
                {/* Projet 1 */}
                <div className='bg-slate-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 w-full md:w-[48%] lg:w-[30%] p-4'>
                    ...
                    <p className='inline-block px-5 rounded bg-slate-600 mt-5 text-blue-400'>Python</p>
                ...
                <div className='bg-slate-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 w-full md:w-[48%] lg:w-[30%] p-4'>
                    ...
                    <div className='flex flex-wrap gap-2 mt-3'>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>HTML</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>Bootstrap</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>JavaScript</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>PHP</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>MySQL</p>
                    </div>
                     <div className='text-end'>
                        <a href=""><button className='px-5 py-2 rounded bg-blue-600'>Voir </button></a>
                    </div>
                 ...
                 <div className='bg-slate-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 w-full md:w-[48%] lg:w-[30%] p-4'>
                    ...
                    <div className='flex flex-wrap gap-2 mt-3'>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>HTML</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>CSS</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>JavaScript</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>Laravel</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600  text-blue-400 text-sm'>MySQL</p>
                    </div>
                    <div className='text-end'>
                ...
                <div className='bg-slate-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 w-full md:w-[48%] lg:w-[30%] p-4'>
                    ...
                    <div className='flex flex-wrap gap-2 mt-3'>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600 text-blue-400 text-sm'>React.js</p>
                        <p className='inline-block px-4 py-1 rounded bg-slate-600 text-blue-400 text-sm'>Tailwind CSS</p>
